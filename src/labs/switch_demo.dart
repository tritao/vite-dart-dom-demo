...
void mountLabsSwitchDemo(web.Element mount) {
  render(mount, () {
    final root = web.HTMLDivElement()
      ..id = "switch-root"
      ..className = "container";

    root.appendChild(labsDemoNav(active: "switch"));

    final checked = createSignal(false);
    final disabled = createSignal(false);

    root.appendChild(web.HTMLHeadingElement.h1()..textContent = "Solidus Labs: Switch");
