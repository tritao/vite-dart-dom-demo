...
void mountLabsRovingDemo(web.Element mount) {
  render(mount, () {
    final root = web.HTMLDivElement()
      ..id = "roving-root"
      ..className = "container";

    root.appendChild(labsDemoNav(active: "roving"));

    final show = createSignal(true);
    final active = createSignal(0);
    final cleanupCount = createSignal(0);

    root.appendChild(web.HTMLHeadingElement.h1()..textContent = "Solidus Labs: Roving");
