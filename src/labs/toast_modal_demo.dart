...
void mountLabsToastModalDemo(web.Element mount) {
  render(mount, () {
    final root = web.HTMLDivElement()
      ..id = "toast-modal-root"
      ..className = "container";

    root.appendChild(labsDemoNav(active: "toast-modal"));
    ...
    root.appendChild(
      web.HTMLHeadingElement.h1()..textContent = "Solidus Labs: Toast + Modal",
    );
