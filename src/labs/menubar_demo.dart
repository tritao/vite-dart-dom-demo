...
void mountLabsMenubarDemo(web.Element mount) {
  render(mount, () {
    final root = web.HTMLDivElement()
      ..id = "menubar-root"
      ..className = "container";

    root.appendChild(labsDemoNav(active: "menubar"));
    ...
    root.appendChild(web.HTMLHeadingElement.h1()..textContent = "Solidus Labs: Menubar");
