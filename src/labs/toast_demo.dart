...
void mountLabsToastDemo(web.Element mount) {
  render(mount, () {
    final root = web.HTMLDivElement()
      ..id = "toast-root"
      ..className = "container";

    root.appendChild(labsDemoNav(active: "toast"));

    final toaster = createToaster(exitMs: 120, defaultDurationMs: 1500);
    final count = createSignal(0);

    root.appendChild(web.HTMLHeadingElement.h1()..textContent = "Solidus Labs: Toast");
