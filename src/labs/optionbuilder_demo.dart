...
void mountLabsOptionBuilderDemo(web.Element mount) {
  render(mount, () {
    final root = web.HTMLDivElement()
      ..id = "optionbuilder-root"
      ..className = "container";

    root.appendChild(labsDemoNav(active: "optionbuilder"));

    root.appendChild(
      web.HTMLHeadingElement.h1()..textContent = "Solidus Labs: OptionBuilder",
    );
