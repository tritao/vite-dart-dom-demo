...
void mountLabsTooltipDemo(web.Element mount) {
  render(mount, () {
    final root = web.HTMLDivElement()
      ..id = "tooltip-root"
      ..className = "container";

    root.appendChild(labsDemoNav(active: "tooltip"));
    ...
    root.appendChild(web.HTMLHeadingElement.h1()..textContent = "Solidus Labs: Tooltip");
