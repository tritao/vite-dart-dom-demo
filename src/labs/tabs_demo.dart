...
void mountLabsTabsDemo(web.Element mount) {
  render(mount, () {
    final root = web.HTMLDivElement()
      ..id = "tabs-root"
      ..className = "container";

    root.appendChild(labsDemoNav(active: "tabs"));
    ...
    root.appendChild(web.HTMLHeadingElement.h1()..textContent = "Solidus Labs: Tabs");
