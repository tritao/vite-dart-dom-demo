...
void mountLabsDropdownMenuDemo(web.Element mount) {
  render(mount, () {
    final root = web.HTMLDivElement()
      ..id = "menu-root"
      ..className = "container";

    root.appendChild(labsDemoNav(active: "dropdownmenu"));
    ...
    root.appendChild(
        web.HTMLHeadingElement.h1()..textContent = "Solidus Labs: DropdownMenu");
