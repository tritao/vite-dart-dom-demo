...
void mountLabsPopoverDemo(web.Element mount) {
  render(mount, () {
    final root = web.HTMLDivElement()
      ..id = "popover-root"
      ..className = "container";

    root.appendChild(labsDemoNav(active: "popover"));
    ...
    root.appendChild(web.HTMLHeadingElement.h1()..textContent = "Solidus Labs: Popover");
    ...
    root.appendChild(
      labsDemoHelp(
        ...
        bullets: const [
          ...
          "Flip H (top-right): shrink viewport width; flip=true switches right-* to left-* (inspect data-solidus-placement).",
    ...
    // Avoid fixed bottom controls intercepting clicks when Playwright scrolls
    // this trigger into view.
    bottomTrigger.style.scrollMarginBottom = "220px";
