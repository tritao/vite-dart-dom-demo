...
void mountLabsAccordionDemo(web.Element mount) {
  render(mount, () {
    final root = web.HTMLDivElement()
      ..id = "accordion-root"
      ..className = "container";

    root.appendChild(labsDemoNav(active: "accordion"));
    ...
    root.appendChild(
      web.HTMLHeadingElement.h1()..textContent = "Solidus Labs: Accordion",
    );
