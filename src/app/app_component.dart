      ...
      dom.section(
        ...
        children: [
          ...
          dom.row(children: [
            ...
            dom.linkButton('Docs', href: '?docs=1'),
            dom.linkButton('Catalog', href: '?lab=catalog'),
            ...
            dom.linkButton('Selection', href: '?lab=selection'),
            dom.linkButton('Toast', href: '?lab=toast'),
            dom.linkButton('Toast+Modal', href: '?lab=toast-modal'),
            dom.linkButton('Roving', href: '?lab=roving'),
            dom.linkButton('Overlay', href: '?lab=overlay'),
            dom.linkButton('Nesting', href: '?lab=nesting'),
            dom.linkButton('OptionBuilder', href: '?lab=optionbuilder'),
            dom.linkButton('DOM', href: '?lab=dom'),
          ]),
        ],
      ),
      dom.spacer(),
