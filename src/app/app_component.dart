      ...
      dom.section(
        ...
        children: [
          ...
          dom.row(children: [
            ...
            dom.linkButton('Selection', href: '?solid=selection'),
            dom.linkButton('Toast', href: '?solid=toast'),
            dom.linkButton('Toast+Modal', href: '?solid=toast-modal'),
            dom.linkButton('Roving', href: '?solid=roving'),
            dom.linkButton('Overlay', href: '?solid=overlay'),
            dom.linkButton('Nesting', href: '?solid=nesting'),
            dom.linkButton('OptionBuilder', href: '?solid=optionbuilder'),
