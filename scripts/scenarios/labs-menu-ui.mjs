export async function runLabsDropdownmenuScenario(page, { timeoutMs }) {
...
export async function runLabsDropdownmenuClickthroughScenario(page, { timeoutMs }) {
  const interactionResults = [];
  let step = "init";
  try {
    const trigger = page.locator("#menu-trigger");
    ...
    if (!(await trigger.count()) || !(await outside.count())) {
      interactionResults.push({
        name: "labs-dropdownmenu-clickthrough",
        ok: false,
...
export async function runLabsDropdownmenuSubmenuScenario(page, { timeoutMs }) {
  const interactionResults = [];
  let step = "init";
  try {
    const trigger = page.locator("#menu-trigger");
    if (!(await trigger.count())) {
      interactionResults.push({
        name: "labs-dropdownmenu-submenu",
        ok: false,
        details: { reason: "missing #menu-trigger" },
      });
    } else {
...
export async function runLabsDropdownmenuRadioScenario(page, { timeoutMs }) {
  const interactionResults = [];
  let step = "init";
  try {
    const trigger = page.locator("#menu-trigger");
...
export async function runLabsDropdownmenuCheckboxDarkScenario(page, { timeoutMs }) {
  const interactionResults = [];
  let step = "init";
  try {
    const trigger = page.locator("#menu-trigger");
    if (!(await trigger.count())) {
      interactionResults.push({
        name: "labs-dropdownmenu-checkbox-dark",
        ok: false,
        details: { reason: "missing #menu-trigger" },
      });
    } else {
...
export async function runLabsMenubarScenario(page, { timeoutMs }) {
  const interactionResults = [];
  let step = "init";
  try {
...
export async function runLabsTabsScenario(page, { timeoutMs }) {
  const interactionResults = [];
  let step = "init";
  try {
...
export async function runLabsAccordionScenario(page, { timeoutMs }) {
  const interactionResults = [];
  let step = "init";
  try {
...
export async function runLabsContextmenuScenario(page, { timeoutMs }) {
  const interactionResults = [];
  let step = "init";
  try {
...
export const labsMenuUiScenarios = {
  "labs-dropdownmenu": runLabsDropdownmenuScenario,
  "labs-dropdownmenu-clickthrough": runLabsDropdownmenuClickthroughScenario,
  "labs-dropdownmenu-submenu": runLabsDropdownmenuSubmenuScenario,
  "labs-dropdownmenu-radio": runLabsDropdownmenuRadioScenario,
  "labs-dropdownmenu-checkbox-dark": runLabsDropdownmenuCheckboxDarkScenario,
  "labs-menubar": runLabsMenubarScenario,
  "labs-tabs": runLabsTabsScenario,
  "labs-accordion": runLabsAccordionScenario,
  "labs-contextmenu": runLabsContextmenuScenario,
};
